...
C {devices/lab_pin.sym} -2390 -3940 0 1 {name=p12 sig_type=std_logic lab=gnd}
C {xor_gate.sym} -2380 -3260 2 1 {name=X9}
C {devices/lab_pin.sym} -2380 -3210 0 0 {name=p15 sig_type=std_logic lab=V}
C {devices/lab_pin.sym} -2380 -3310 0 1 {name=p18 sig_type=std_logic lab=gnd}
